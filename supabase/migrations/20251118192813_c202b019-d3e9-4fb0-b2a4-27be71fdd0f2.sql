-- Fonction de vérification du montant facturé vs BC
...
-- Créer le trigger
CREATE TRIGGER check_facture_montant_before_insert_update
  BEFORE INSERT OR UPDATE ON factures
  FOR EACH ROW
  EXECUTE FUNCTION check_facture_montant_vs_bc();